...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="MAX 10" ENABLE_RUNTIME_MOD="YES" INIT_FILE="instMIF.mif" INSTANCE_NAME="0001" NUMWORDS_A=4096 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" RAM_BLOCK_TYPE="M9K" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block3a_2.mem_init0 = 2048',
	...
	defparam
		...
		ram_block3a_3.mem_init0 = 2048',
	...
	defparam
		...
		ram_block3a_4.mem_init0 = 2048',
	...
	defparam
		...
		ram_block3a_5.mem_init0 = 2048',
	...
	defparam
		...
		ram_block3a_7.mem_init0 = 2048',
...
`endif
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Memory initialization file instMIF.mif is not of the dimensions 4096 X 8, the resulting memory design may not produce consistent simulation results.");
	end
